...
function SignUp({ setSignIn }) {
    ...
    const fetchData = async () => {
        ...
        const data = {
         ...
         await  axios.post('http://192.168.29.145:3001/api/user/register', data, config)
            .then(response => {
                ...
                <div class="bg-grey-lighter min-h-screen flex flex-col rounded-lg">
                    <div class="container max-w-sm mx-auto flex-1 flex flex-col items-center justify-center px-2">
                        <div class="bg-white px-6 py-8 rounded shadow-md text-black w-full">
                            ...
                            <button
                                type="submit"
                                class="w-full text-center py-3 text-xl rounded bg-green bg-blue-800 text-slate-50 hover:bg-green-dark focus:outline-none my-1" onClick={fetchData}
